...
```{r}
Telco <- read.csv(file= 'C:/Areefa_Brunel/CS5811_Distributed_Data_Analysis/Coursework_Submission/Telco_Customer_Churn.csv')
```
...
```{r}
numeric_vars <- Telco_cleandata %>%
  select_if(is.numeric)

ggplot(melt(numeric_vars), aes(value)) +
